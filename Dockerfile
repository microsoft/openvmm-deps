...
ADD --checksum=sha256:61b30d408583991fd69f3dec694e154cb652471e663328ad9c8482c9021ab5db --link https://git.savannah.gnu.org/gitweb/?p=config.git;a=blob_plain;f=config.sub;hb=3d5db9ebe860 /sources/config.sub
